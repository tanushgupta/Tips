...
public class ExecuteTip extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        /*
                  ...
                  "orderType": "MARKET"
         */
        final String accessToken = ((OneTouchMainActivity)getActivity()).getUser().getAcessToken();
