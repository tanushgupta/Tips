...
//                    System.out.println(" \n\n\n new Entry ");
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        viewHolder.tiprow_analystName.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        viewHolder.txt_tip_count.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectedTip=advisorList.get(i);
        ...
        viewHolder.tiprow_executedTipCount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectedTip=advisorList.get(i);
        ...
        viewHolder.tiprow_profileIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectedTip=advisorList.get(i);
